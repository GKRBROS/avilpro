        ...
        <div className={styles.grid}>
          ...
          <div className={styles.column}>
            ...
            <div className={styles.socials}>
               <a href="https://instagram.com/avilpro_official" target="_blank" rel="noopener noreferrer" aria-label="Avilpro on Instagram" className={styles.socialIcon}>
               ...
               <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" aria-label="Avilpro on Facebook" className={styles.socialIcon}>
                 <svg viewBox="0 0 24 24" width="20" height="20" stroke="currentColor" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round">
