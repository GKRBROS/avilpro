...
export default function WhatsAppFloat() {
  ...
  const handlePointerEnter = () => setShowLabel(true);
  const handlePointerLeave = () => setShowLabel(false);
  ...
  const handleTouchStart = () => {
    ...
    // Keep label visible briefly after touch so users can read it.
  ...
  return (
    <AnimatePresence>
      {loaded && (
        ...
        >
          <div className={`${styles.text} ${showLabel ? styles.textVisible : ""}`}>Chat with us</div>
          <div className={styles.iconBox}>
            <svg viewBox="0 0 448 512" width="28" height="28" fill="#25D366">
